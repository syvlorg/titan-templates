...
(defmacro meq/titan-append-modes (mode &rest exts) (let* ((titan-exts (meq/inconcat "meq/var/titan-" (symbol-name mode) "-exts"))) (append (and (symbol-value titan-exts) nil) exts)))
